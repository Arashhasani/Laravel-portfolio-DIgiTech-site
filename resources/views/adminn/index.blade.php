											...
											<span class="mr-4">
												<svg width="50" height="53" viewBox="0 0 50 53" fill="none"
													...
													<rect width="7.11688" height="52.1905" rx="3.55844"
                                                          transform="matrix(-1 0 0 1 49.8184 0)" fill="#FE634E"/>
													<rect width="7.11688" height="37.9567" rx="3.55844"
                                                          transform="matrix(-1 0 0 1 35.585 14.2338)" fill="#FE634E"/>
													<rect width="7.11688" height="16.6061" rx="3.55844"
                                                          transform="matrix(-1 0 0 1 21.3516 35.5844)" fill="#FE634E"/>
													<rect width="8.0293" height="32.1172" rx="4.01465"
                                                          transform="matrix(-1 0 0 1 8.0293 20.0732)" fill="#FE634E"/>
												</svg>
											</span>
                                <div class="media-body ml-1">
                                    <p class="mb-2">Users</p>
                                    <h3 class="mb-0 text-black font-w600">{{count(\App\Models\User::all())}}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="media align-items-center">
                                ...
                                <div class="media-body ml-1">
                                    ...
                                    <h3 class="mb-0 text-black font-w600">{{count(\App\Models\Comment::all())}}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="media align-items-center">
                                ...
                                <div class="media-body ml-1">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <h3 class="mb-0 mr-3 text-black font-w600">{{count(\App\Models\Article::all())}}</h3>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-responsive-md">
                            ...
                            @foreach(\App\Models\Article::query()->orderBy('id','asc')->limit(10)->get() as $article)
